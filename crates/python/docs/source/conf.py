...
html_title = "COSMol Viewer — Rust-native molecular visualization"
...
html_theme = "furo"
html_baseurl = "https://viewer.cosmol.org/"
html_extra_path = [
    "robots.txt",
    "1d047fb8-319c-41ca-8fa0-3955d72ece0f.txt",
]
html_static_path = ["_static"]
html_css_files = ["cosmol_viewer.css"]
