    ...
    rsx! {
        ...
        footer {
            ...
            div {
                ...
                span { class: "font-semibold text-[#9caabd]", "COSMol Viewer documentation" }
                nav { class: "cosmol_viewer-project-links flex flex-wrap gap-x-5 gap-y-2", aria_label: "Project and Rust crates",
                    for (label, href) in [
                        ("GitHub", "https://github.com/cosmol-studio/COSMol-viewer"),
                        ("Python package", "https://pypi.org/project/cosmol-viewer/"),
                        ("cosmol_viewer", "https://crates.io/crates/cosmol_viewer"),
                        ("cosmol_viewer_core", "https://crates.io/crates/cosmol_viewer_core"),
                        ("Rust API", "https://docs.rs/cosmol_viewer/latest/cosmol_viewer/"),
                        ("Documentation", "https://viewer.cosmol.org/"),
