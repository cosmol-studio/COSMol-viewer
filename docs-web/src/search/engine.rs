...
mod tests {
    ...
    fn index() -> SearchIndex {
        SearchIndex::load(r##"[
            ...
            {"title":"cosmol_viewer.Molecule.add_atom","url":"/python/api#cosmol_viewer.Molecule.add_atom","summary":"Python method","text":"Add an atom"},
            {"title":"cosmol_viewer.Molecule","url":"/python/api#cosmol_viewer.Molecule","summary":"Python class","text":"Molecular graph"},
            {"title":"分子结构","url":"/python/molecule","summary":"Unicode","text":"分子和原子"},
            {"title":"cosmol_viewer.from_smiles","url":"/python/api#from_smiles","summary":"Python function","text":"Create a molecule"}
        ]"##).unwrap()
    }
