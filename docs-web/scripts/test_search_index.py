...
class SearchIndexTests(unittest.TestCase):
    def setUp(self):
        ...
        self.index = {"docnames": ["api"], "titles": ["API Reference"],
                      "objects": {"cosmol_viewer": [[0, 0, 0, "", "Molecule"]]},
    ...
    def test_page_body_and_symbol_anchor_are_preserved(self):
        ...
        self.assertEqual(records[1]["url"], "/python/api#cosmol_viewer.Molecule")
    ...
    def test_binding_tool_version_must_match_the_rust_dependency(self):
        ...
        with patch("build_search_bundle.shutil.which", return_value=None), patch.dict("os.environ", {"COSMOL_VIEWER_WASM_BINDGEN": "missing"}):
    ...
    def test_generated_assets_use_crate_relative_paths(self):
        ...
        for name in ('docs_search.js', 'docs_search_bg.wasm'):
            ...
            linux_root = PurePosixPath('/home/runner/work/COSMol-viewer/COSMol-viewer/docs-web')
